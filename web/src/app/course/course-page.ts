import { Component, ViewEncapsulation, signal, OnInit, inject, ChangeDetectionStrategy } from '@angular/core';
...
import { COURSE_GROUP_DATA, GroupKey, SimpleCourse } from '../data/course-data';
